...
<html>
	...
	<body>
		<header>
			...
			<div class='lang-menu'>
					<a href='index_nivola.jsp'>Italiano</a>
		...
		<div class='content'>
			...
			<div class='indent'>
				<div>
					<strong>Base search Url format JSON</strong><pre><code>https://api.smartdataplatform.csi.it/metadataapi/api/v02/search?</code></pre>
				</div>
				<div>
					<strong>Base search Url format CKAN</strong><pre><code>https://api.smartdataplatform.csi.it/metadataapi/api/ckan/2/package_list?</code></pre>
				</div>
				<div>
					<strong>Base Url Data Catalog Interoperability Protocol (DCAT-AP-IT) format JSON+LD</strong><pre><code>https://api.smartdataplatform.it/metadataapi/api/dcat/dataset_list?</code></pre>
				</div>
				<div class='deprecated'>
					...
					<pre><code>https://api.smartdataplatform.csi.it/metadataapi/api/search/full?</code></pre>
				</div>
			...
			<div class='indent'>
				<div>
					<strong>Base Detail URL for stream with output in JSON format</strong><pre><code>https://api.smartdataplatform.csi.it/metadataapi/api/v02/detail/<span class='url-dynamic-parameter-tenant'>{{tenantCode}}</span>/<span class='url-dynamic-parameter-smartobject'>{{smartobjectCode}}</span>/<span class='url-dynamic-parameter-stream'>{{streamCode}}</span>?</code></pre>
				where: 
					<ul>
				...
				<div>
					<strong>Base Detail URL for dataset with output in JSON format</strong><pre><code>https://api.smartdataplatform.csi.it/metadataapi/api/v02/detail/<span class='url-dynamic-parameter-tenant'>{{tenantCode}}</span>/<span class='url-dynamic-parameter-dataset'>{{datasetCode}}</span></code></pre>
					where: 
					<ul>
						<li><span class='url-dynamic-parameter-tenant'>{{tenantCode}}</span> is the Tenant code of the owner of the stream</li>
				...
				<div>
					<strong>Base Detail URL  with output in CKAN format</strong><pre><code>https://api.smartdataplatform.csi.it/metadataapi/api/ckan/2/package_list/<span class='url-dynamic-parameter-package-id'>{{packageId}}</span></code></pre> 
					where:
					<ul>
			...
			<div class='indent'>
				...
				<p>The oAuth token are avaible in the section  <cite><strong>Subscriptions</strong></cite> in the   <a href='https://userportal.smartdataplatform.csi.it/userportal' target='_blank'>Userportal</a> (visible only if logged in)</p>
